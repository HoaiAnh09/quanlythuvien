...
public:
    ...
    void xuatLopSinhVien() const {
        cout << setw(15) << left << MaSV << setw(15) << left << HoTen << setw(15) << left << NgaySinh<< setw(15) << left <<DiaChi<< setw(15) << left <<SoDT << endl;
    }
};
...
public:
    ...
    void xuatLopSach() const {
        cout << setw(15) << left << MaSach << setw(15) << left << TenSach << setw(15) << left << TacGia << setw(15) << left <<NamXB<< setw(15) << left <<TheLoai << endl;
...
public:
    ...
    void XuatDanhSachSV() {
        ...
        cout << "--------------------------------"<<endl;;
        cout << left << setw(15) << "MaSV" << setw(15) << "Ho ten" << setw(15) << "Ngay sinh" << setw(15) << "Dia Chi" << setw(15) << "SoDT" << endl;
    ...
    void XuatDanhSachSach() {
        ...
        cout << "--------------------------------"<<endl;
        cout << setw(15) << left << "Ma Sach" << setw(15) << left << "Ten Sach" << setw(15) << left << "Tac Gia" << setw(15) << left <<"Nam XB"<< setw(15) << left <<"The Loai" << endl;
